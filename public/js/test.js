$(window).on("load", function () {
    ...
    $(".edit-ride").on("click", function () {
        if (
            ...
            let contact = $(
                ".ride.selected .passenger-info .pass-contact"
            ).text();
    ...
    $("#ride-changer").submit(function () {
        ...
        if (rideName == "Return") {
            $(".ride.selected .other-info i").attr(
                "class",
        ...
        $(".ride.selected").attr(
            "class",
            "ride resize butNotHere " + changedRide
        );
    ...
    $("#select-driver").submit(function () {
        ...
        if ($(".ride").hasClass("change-driver")) {
            ...
            $("#assign-driver .modal-header .modal-title h4").text(
                "Assign A Driver"
            );
        }
