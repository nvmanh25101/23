...
@section('content')
    ...
    <div class="col-12">
        <a href="{{ route('student.create') }}" class="btn btn-outline-primary">Thêm mới</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {{-- <form method="post" action="{{ route('student.import_csv' ) }}" enctype="multipart/form-data" id="import-csv"> --}}
                        {{-- @csrf --}}
                        <div class="">
                            <a class="btn btn-info"
                                href="https://docs.google.com/spreadsheets/d/e/2PACX-1vSIPyKDBCXttPO2HfcXmu9BMe2oUtS8Ihj7CGjpDQYjvAgX9HX1tOy_Tt4LrLwMMKPaV0vSSexKwHPL/pubhtml"
